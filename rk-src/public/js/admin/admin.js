...
async function realTimeLogs() {
    ...
    // logging
    const loggingEvent = new EventSource(`http://localhost:3000/logs/${loggingModule}`);
    ...
    // userops
    const useropsEvent = new EventSource(`http://localhost:3000/logs/${useropsModule}`);
    ...
    // sellerops
    const selleropsEvent = new EventSource(`http://localhost:3000/logs/${selleropsModule}`);
    ...
    // chainapi
    const chainapiEvent = new EventSource(`http://localhost:3000/logs/${chainapiModule}`);
